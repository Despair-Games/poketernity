...
describe("Test Battle Phase", () => {
  ...
  it("startBattle 2vs2 boss", async () => {
    game.overridesHelper.battleType("double").startingWave(10);
    await game.startBattle([Species.BLASTOISE, Species.CHARIZARD]);
    expect(game.scene.ui?.getMode()).toBe(Mode.COMMAND);
    expect(game.scene.getCurrentPhase()!.constructor.name).toBe(CommandPhase.name);
  }, 20000);
  ...
  it("startBattle 2vs2 trainer", async () => {
    game.overridesHelper.battleType("double").startingWave(5);
    await game.startBattle([Species.BLASTOISE, Species.CHARIZARD]);
    expect(game.scene.ui?.getMode()).toBe(Mode.COMMAND);
    expect(game.scene.getCurrentPhase()!.constructor.name).toBe(CommandPhase.name);
  }, 20000);
  ...
  it("startBattle 2vs1 trainer", async () => {
    game.overridesHelper.battleType("single").startingWave(5);
    await game.startBattle([Species.BLASTOISE, Species.CHARIZARD]);
    expect(game.scene.ui?.getMode()).toBe(Mode.COMMAND);
    expect(game.scene.getCurrentPhase()!.constructor.name).toBe(CommandPhase.name);
  }, 20000);
  ...
  it("startBattle 2vs1 rival", async () => {
    game.overridesHelper.battleType("single").startingWave(8);
    await game.startBattle([Species.BLASTOISE, Species.CHARIZARD]);
    expect(game.scene.ui?.getMode()).toBe(Mode.COMMAND);
    expect(game.scene.getCurrentPhase()!.constructor.name).toBe(CommandPhase.name);
  }, 20000);
  ...
  it("startBattle 2vs2 rival", async () => {
    game.overridesHelper.battleType("double").startingWave(8);
    await game.startBattle([Species.BLASTOISE, Species.CHARIZARD]);
    expect(game.scene.ui?.getMode()).toBe(Mode.COMMAND);
    expect(game.scene.getCurrentPhase()!.constructor.name).toBe(CommandPhase.name);
  }, 20000);
