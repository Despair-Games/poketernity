...
import type { ArenaTagDataMap, ArenaTagTypeMap, SerializableArenaTagType } from "#types/arena-tag-types";
 ...
 * @param expectedTag - The {@linkcode ArenaTagType} of the desired tag,
...
export function toHaveArenaTag<A extends ArenaTagType>(
  ...
  const tags = received.scene.arena.getTags((t) => t.tagType === etag.tagType, etag.side) ?? [];
