...
describe("Moves - Dig", () => {
  ...
  it("should cause the user to take double damage from Earthquake", async () => {
    ...
    const preDigEarthquakeDmg = playerPokemon.getAttackDamage(enemyPokemon, allMoves[Moves.EARTHQUAKE]).finalDamage;
    ...
    const postDigEarthquakeDmg = playerPokemon.getAttackDamage(enemyPokemon, allMoves[Moves.EARTHQUAKE]).finalDamage;
