...
describe("SelectModifierPhase", () => {
  ...
  it("should modify reroll cost", async () => {
    ...
    const selectModifierPhase1 = new SelectModifierPhase(scene, 0, undefined, {
      guaranteedModifierTypeOptions: options,
    });
    const selectModifierPhase2 = new SelectModifierPhase(scene, 0, undefined, {
      guaranteedModifierTypeOptions: options,
      rerollMultiplier: 2,
    });
  ...
  it("should generate random modifiers from reroll", async () => {
    ...
    selectModifierPhase = new SelectModifierPhase(scene, 1, [
      ModifierTier.COMMON,
      ModifierTier.COMMON,
      ModifierTier.COMMON,
    ]);
  ...
  it("should generate custom modifier tiers that can upgrade from luck", async () => {
    ...
    const pokemon = new PlayerPokemon(
      scene,
      getPokemonSpecies(Species.BULBASAUR),
      10,
      undefined,
      0,
      undefined,
