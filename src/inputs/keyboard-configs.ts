...
const commonKeyboardDeviceMapping = Object.freeze({
...
const commonKeyboardIcons = Object.freeze({
  KEY_A: "A.png",
  KEY_B: "B.png",
  KEY_C: "C.png",
  KEY_D: "D.png",
...
const commonKeyboardSettings = Object.freeze({
...
const unmappedKeys = Object.freeze({
  KEY_A: -1,
  KEY_B: -1,
  KEY_C: -1,
  KEY_D: -1,
...
const commonKeymap = Object.freeze({
  ...unmappedKeys,
...
const baseKeyboardConfig = Object.freeze({
  padType: "keyboard",
  deviceMapping: commonKeyboardDeviceMapping,
  icons: commonKeyboardIcons,
  settings: commonKeyboardSettings,
});
...
const qwertzKeymap = {
  ...
  KEY_A: SettingKeyboard.Alt_Button_Left,
  KEY_W: SettingKeyboard.Alt_Button_Up,
  KEY_Y: SettingKeyboard.Alt_Button_Action,
  KEY_Z: SettingKeyboard.Alt_Button_Cycle_Shiny,
};
