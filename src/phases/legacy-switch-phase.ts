 ...
 *
 * @extends
 * @deprecated Use {@linkcode BattleScene.promptSelectPlayerPokemon} instead
 */
export class LegacySwitchPhase extends BattlePhase {
  ...
  /**
   * Creates a new LegacySwitchPhase
