...
import ArenaData from "#app/server-data/arena-data";
...
import EggData from "#app/server-data/egg-data";
...
import { GameStats } from "#app/server-data/game-stats";
...
import ChallengeData from "#app/server-data/challenge-data";
...
import type { DexData, DexEntry } from "#app/server-data/dex-data";
