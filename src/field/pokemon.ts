...
import { IgnoreTypeImmunityAbAttr } from "#app/data/ab-attr/ignore-type-immunity-ab-attr";
import { NoFusionAbilityAbAttr } from "#app/data/ab-attr/no-fusion-ability-ab-attr";
import { UnsuppressableAbilityAbAttr } from "#app/data/ab-attr/unsuppressable-ability-ab-attr";
import { InfiltratorAbAttr } from "#app/data/ab-attr/infiltrator-ab-attr";
import { SuppressFieldAbilitiesAbAttr } from "#app/data/ab-attr/suppress-field-abilities-ab-attr";
import { WeightMultiplierAbAttr } from "#app/data/ab-attr/weight-multiplier-ab-attr";
import { CheckTrappedAbAttr } from "#app/data/ab-attr/check-trapped-ab-attr";
import { BypassBurnDamageReductionAbAttr } from "#app/data/ab-attr/bypass-burn-damage-reduction-ab-attr";
import { PostItemLostAbAttr } from "#app/data/ab-attr/post-item-lost-ab-attr";
import { ConditionalCritAbAttr } from "#app/data/ab-attr/conditional-crit-ab-attr";
import { MultCritAbAttr } from "#app/data/ab-attr/mult-crit-ab-attr";
import { BonusCritAbAttr } from "#app/data/ab-attr/bonus-crit-ab-attr";
import { BlockCritAbAttr } from "#app/data/ab-attr/block-crit-ab-attr";
import { UserFieldBattlerTagImmunityAbAttr } from "#app/data/ab-attr/user-field-battler-tag-immunity-ab-attr";
import { BattlerTagImmunityAbAttr } from "#app/data/ab-attr/battler-tag-immunity-ab-attr";
import { UserFieldStatusEffectImmunityAbAttr } from "#app/data/ab-attr/user-field-status-effect-immunity-ab-attr";
import { StatusEffectImmunityAbAttr } from "#app/data/ab-attr/status-effect-immunity-ab-attr";
import { CommanderAbAttr } from "#app/data/ab-attr/commander-ab-attr";
import { IgnoreOpponentStatStagesAbAttr } from "#app/data/ab-attr/ignore-opponent-stat-stages-ab-attr";
import { PostSetStatusAbAttr } from "#app/data/ab-attr/post-set-status-ab-attr";
import { StatMultiplierAbAttr } from "#app/data/ab-attr/stat-multiplier-ab-attr";
import { DamageBoostAbAttr } from "#app/data/ab-attr/damage-boost-ab-attr";
import { AddSecondStrikeAbAttr } from "#app/data/ab-attr/add-second-strike-ab-attr";
import { MoveTypeChangeAbAttr } from "#app/data/ab-attr/move-type-change-ab-attr";
import { FieldMultiplyStatAbAttr } from "#app/data/ab-attr/field-multiply-stat-ab-attr";
...
import { IgnoreTypeStatusEffectImmunityAbAttr } from "#app/data/ab-attr/ignore-type-status-effect-immunity-ab-attr";
import type { AbAttr } from "#app/data/ab-attr/ab-attr";
import { PostDamageAbAttr } from "#app/data/ab-attr/post-damage-ab-attr";
import { PreDefendFullHpEndureAbAttr } from "#app/data/ab-attr/pre-defend-full-hp-endure-ab-attr";
import { StabBoostAbAttr } from "#app/data/ab-attr/stab-boost-ab-attr";
import { ReceivedMoveDamageMultiplierAbAttr } from "#app/data/ab-attr/received-move-damage-multiplier-ab-attr";
import { AlliedFieldDamageReductionAbAttr } from "#app/data/ab-attr/allied-field-damage-reduction-ab-attr";
import { TypeImmunityAbAttr } from "#app/data/ab-attr/type-immunity-ab-attr";
import { FullHpResistTypeAbAttr } from "#app/data/ab-attr/full-hp-resist-type-ab-attr";
import { FieldPriorityMoveImmunityAbAttr } from "#app/data/ab-attr/field-priority-move-immunity-ab-attr";
import { MoveImmunityAbAttr } from "#app/data/ab-attr/move-immunity-ab-attr";
...
export abstract class Pokemon extends Phaser.GameObjects.Container {
  ...
  getAttackTypeEffectiveness(
    ...
    const typeMultiplierAgainstFlying = new NumberHolder(getTypeDamageMultiplier(moveType, Type.FLYING));
  ...
  getAttackDamage(
    ...
    const mistyTerrainMultiplier =
      globalScene.arena.terrain?.terrainType === TerrainType.MISTY && this.isGrounded() && moveType === Type.DRAGON
        ? 0.5
        : 1;
  ...
  apply(source: Pokemon, move: Move): HitResult {
    ...
    if (moveCategory.value === MoveCategory.STATUS) {
      ...
      const typeBoost = source.findTag(
        (t) => t instanceof TypeBoostTag && t.boostedType === source.getMoveType(move),
      ) as TypeBoostTag;
      if (typeBoost?.oneUse) {
      ...
      if (dmg) {
        ...
        if (damage > 0) {
          ...
          if (source.isPlayer() && !this.isPlayer()) {
            globalScene.applyModifiers(DamageMoneyRewardModifier, true, source, new NumberHolder(damage));
          }
        }
      }
