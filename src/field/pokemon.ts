...
import type { DamageCalculationResult } from "#app/@types/damage-calculation-result";
import type { DamageFunctionOptions } from "#app/@types/damage-function-options";
import type { PokemonTurnData } from "#app/@types/pokemon-turn-data";
import type { PokemonWaveData } from "#app/@types/pokemon-wave-data";
