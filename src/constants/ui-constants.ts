...
/**
 * Scale by which the {@linkcode GAME_WIDTH} and {@linkcode GAME_HEIGHT} get multiplied to create the game canvas.
 *
 ...
 * for a text object that should be at most `100` pixels wide (not taking into account {@linkcode CANVAS_SCALE}),
