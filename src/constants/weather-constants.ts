 ...
 */
export const PRIMAL_WEATHER_TYPES = Object.freeze<AtLeastOneArray<WeatherType>>([
...
export const SUNNY_WEATHER_TYPES = Object.freeze<AtLeastOneArray<WeatherType>>([
  WeatherType.SUNNY,
  WeatherType.HARSH_SUN,
]);

/** Weather types that are associated with rainy weather. */
export const RAINY_WEATHER_TYPES = Object.freeze<AtLeastOneArray<WeatherType>>([
  WeatherType.RAIN,
  WeatherType.HEAVY_RAIN,
]);

/** Weather types that are associated with snowy weather. */
export const SNOWY_WEATHER_TYPES = Object.freeze<AtLeastOneArray<WeatherType>>([WeatherType.SNOW, WeatherType.HAIL]);

/** Weather types that cause damage to pokemon at end of turn. */
export const DAMAGING_WEATHER_TYPES = Object.freeze<AtLeastOneArray<WeatherType>>([
  WeatherType.HAIL,
