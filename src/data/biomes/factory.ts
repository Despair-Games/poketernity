...
const pokemonPool = {
  [BiomePoolTier.COMMON]: {
    ...
    [TimeOfDay.DUSK]: [],
    [TimeOfDay.NIGHT]: [],
    [TimeOfDay.ALL]: [SpeciesId.MACHOP, SpeciesId.MAGNEMITE, SpeciesId.VOLTORB, SpeciesId.TIMBURR, SpeciesId.KLINK],
  },
  [BiomePoolTier.UNCOMMON]: {
    ...
    [TimeOfDay.DUSK]: [],
    [TimeOfDay.NIGHT]: [],
    [TimeOfDay.ALL]: [SpeciesId.BRONZOR, SpeciesId.KLEFKI],
  },
  [BiomePoolTier.RARE]: {
    [TimeOfDay.DAWN]: [],
    [TimeOfDay.DAY]: [],
...
export const factoryBiome = new Biome(BiomeId.FACTORY, pokemonPool, trainerPool, 8, weatherPool, terrainPool, "town");
