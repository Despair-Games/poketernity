...
import { PreventBypassSpeedChanceAbAttr } from "./ab-attr/prevent-bypass-speed-chance-ab-attr";
import { FormBlockDamageAbAttr } from "./ab-attr/form-block-damage-ab-attr";
import { PostSummonStatStageChangeOnArenaAbAttr } from "./ab-attr/post-summon-stat-stage-change-on-arena-ab-attr";
import { MoneyAbAttr } from "./ab-attr/money-ab-attr";
import { IgnoreTypeImmunityAbAttr } from "./ab-attr/ignore-type-immunity-ab-attr";
import { NoFusionAbilityAbAttr } from "./ab-attr/no-fusion-ability-ab-attr";
import { NoTransformAbilityAbAttr } from "./ab-attr/no-transform-ability-ab-attr";
...
import { AlwaysHitAbAttr } from "./ab-attr/always-hit-ab-attr";
import { SuppressFieldAbilitiesAbAttr } from "./ab-attr/suppress-field-abilities-ab-attr";
import { MoveAbilityBypassAbAttr } from "./ab-attr/move-ability-bypass-ab-attr";
import { SyncEncounterNatureAbAttr } from "./ab-attr/sync-encounter-nature-ab-attr";
import { WeightMultiplierAbAttr } from "./ab-attr/weight-multiplier-ab-attr";
import { ReduceBerryUseThresholdAbAttr } from "./ab-attr/reduce-berry-use-threshold-ab-attr";
import { ForceSwitchOutImmunityAbAttr } from "./ab-attr/force-switch-out-immunity-ab-attr";
import { IncreasePpAbAttr } from "./ab-attr/increase-pp-ab-attr";
import { FlinchStatStageChangeAbAttr } from "./ab-attr/flinch-stat-stage-change-ab-attr";
import { ReduceStatusEffectDurationAbAttr } from "./ab-attr/reduce-status-effect-duration-ab-attr";
import { BlockRedirectAbAttr } from "./ab-attr/block-redirect-ab-attr";
import { RedirectTypeMoveAbAttr } from "./ab-attr/redirect-type-move-ab-attr";
import { PostFaintClearWeatherAbAttr } from "./ab-attr/post-faint-clear-weather-ab-attr";
import { PostFaintUnsuppressedWeatherFormChangeAbAttr } from "./ab-attr/post-faint-unsuppressed-weather-form-change-ab-attr";
import { MaxMultiHitAbAttr } from "./ab-attr/max-multi-hit-ab-attr";
import { RunSuccessAbAttr } from "./ab-attr/run-success-ab-attr";
import { PreventBerryUseAbAttr } from "./ab-attr/prevent-berry-use-ab-attr";
import { DoubleBerryEffectAbAttr } from "./ab-attr/double-berry-effect-ab-attr";
import { ReduceBurnDamageAbAttr } from "./ab-attr/reduce-burn-damage-ab-attr";
import { BypassBurnDamageReductionAbAttr } from "./ab-attr/bypass-burn-damage-reduction-ab-attr";
import { StatStageChangeCopyAbAttr } from "./ab-attr/stat-stage-change-copy-ab-attr";
import { StatStageChangeMultiplierAbAttr } from "./ab-attr/stat-stage-change-multiplier-ab-attr";
import { PostItemLostApplyBattlerTagAbAttr } from "./ab-attr/post-item-lost-apply-battler-tag-ab-attr";
import { PostDancingMoveAbAttr } from "./ab-attr/post-dancing-move-ab-attr";
import { PostBiomeChangeTerrainChangeAbAttr } from "./ab-attr/post-biome-change-terrain-change-ab-attr";
import { PostBiomeChangeWeatherChangeAbAttr } from "./ab-attr/post-biome-change-weather-change-ab-attr";
import { PostTurnFormChangeAbAttr } from "./ab-attr/post-turn-form-change-ab-attr";
import { SpeedBoostAbAttr } from "./ab-attr/speed-boost-ab-attr";
import { MoodyAbAttr } from "./ab-attr/moody-ab-attr";
import { PostTurnResetStatusAbAttr } from "./ab-attr/post-turn-reset-status-ab-attr";
import { PostTerrainChangeAddBattlerTagAttr } from "./ab-attr/post-terrain-change-add-battler-tag-attr";
import { PostWeatherChangeAddBattlerTagAttr } from "./ab-attr/post-weather-change-add-battler-tag-ab-attr";
import { PostWeatherChangeFormChangeAbAttr } from "./ab-attr/post-weather-change-form-change-ab-attr";
import { SuppressWeatherEffectAbAttr } from "./ab-attr/suppress-weather-effect-ab-attr";
import { BlockWeatherDamageAttr } from "./ab-attr/block-weather-damage-attr";
...
import { BlockStatusDamageAbAttr } from "./ab-attr/block-status-damage-ab-attr";
import { BlockNonDirectDamageAbAttr } from "./ab-attr/block-non-direct-damage-ab-attr";
import { ConditionalCritAbAttr } from "./ab-attr/conditional-crit-ab-attr";
import { MultCritAbAttr } from "./ab-attr/mult-crit-ab-attr";
import { BonusCritAbAttr } from "./ab-attr/bonus-crit-ab-attr";
import { BlockCritAbAttr } from "./ab-attr/block-crit-ab-attr";
import { UserFieldBattlerTagImmunityAbAttr } from "./ab-attr/user-field-battler-tag-immunity-ab-attr";
import { BattlerTagImmunityAbAttr } from "./ab-attr/battler-tag-immunity-ab-attr";
import { UserFieldStatusEffectImmunityAbAttr } from "./ab-attr/user-field-status-effect-immunity-ab-attr";
import { StatusEffectImmunityAbAttr } from "./ab-attr/status-effect-immunity-ab-attr";
import { ConfusionOnStatusEffectAbAttr } from "./ab-attr/confusion-on-status-effect-ab-attr";
import { PreSwitchOutFormChangeAbAttr } from "./ab-attr/pre-switch-out-form-change-ab-attr";
import { PreSwitchOutHealAbAttr } from "./ab-attr/pre-switch-out-heal-ab-attr";
import { PreSwitchOutClearWeatherAbAttr } from "./ab-attr/pre-switch-out-clear-weather-ab-attr";
import { PreSwitchOutResetStatusAbAttr } from "./ab-attr/pre-switch-out-reset-status-ab-attr";
import { CommanderAbAttr } from "./ab-attr/commander-ab-attr";
import { PostSummonFormChangeByWeatherAbAttr } from "./ab-attr/post-summon-form-change-by-weather-ab-attr";
import { PostSummonUserFieldRemoveStatusEffectAbAttr } from "./ab-attr/post-summon-user-field-remove-status-effect-ab-attr";
import { PostSummonFormChangeAbAttr } from "./ab-attr/post-summon-form-change-ab-attr";
import { PostSummonTerrainChangeAbAttr } from "./ab-attr/post-summon-terrain-change-ab-attr";
import { PostSummonWeatherChangeAbAttr } from "./ab-attr/post-summon-weather-change-ab-attr";
import { DownloadAbAttr } from "./ab-attr/download-ab-attr";
import { PostSummonStatStageChangeAbAttr } from "./ab-attr/post-summon-stat-stage-change-ab-attr";
import { PostSummonAddBattlerTagAbAttr } from "./ab-attr/post-summon-add-battler-tag-ab-attr";
import { PostSummonUnnamedMessageAbAttr } from "./ab-attr/post-summon-unnamed-message-ab-attr";
import { PostSummonMessageAbAttr } from "./ab-attr/post-summon-message-ab-attr";
import { PostSummonRemoveArenaTagAbAttr } from "./ab-attr/post-summon-remove-arena-tag-ab-attr";
import { PostIntimidateStatStageChangeAbAttr } from "./ab-attr/post-intimidate-stat-stage-change-ab-attr";
import { IgnoreOpponentStatStagesAbAttr } from "./ab-attr/ignore-opponent-stat-stages-ab-attr";
import { PostKnockOutStatStageChangeAbAttr } from "./ab-attr/post-knock-out-stat-stage-change-ab-attr";
import { PostVictoryFormChangeAbAttr } from "./ab-attr/post-victory-form-change-ab-attr";
import { PostVictoryStatStageChangeAbAttr } from "./ab-attr/post-victory-stat-stage-change-ab-attr";
import { SynchronizeStatusAbAttr } from "./ab-attr/synchronize-status-ab-attr";
import { PostAttackApplyBattlerTagAbAttr } from "./ab-attr/post-attack-apply-battler-tag-ab-attr";
import { PostAttackContactApplyStatusEffectAbAttr } from "./ab-attr/post-attack-contact-apply-status-effect-ab-attr";
import { PostAttackApplyStatusEffectAbAttr } from "./ab-attr/post-attack-apply-status-effect-ab-attr";
import { GorillaTacticsAbAttr } from "./ab-attr/gorilla-tactics-ab-attr";
import { StatMultiplierAbAttr } from "./ab-attr/stat-multiplier-ab-attr";
...
import { VariableMovePowerBoostAbAttr } from "./ab-attr/variable-move-power-boost-ab-attr";
import { LowHpMoveTypePowerBoostAbAttr } from "./ab-attr/low-hp-move-type-power-boost-ab-attr";
import { MoveTypePowerBoostAbAttr } from "./ab-attr/move-type-power-boost-ab-attr";
import { MovePowerBoostAbAttr } from "./ab-attr/move-power-boost-ab-attr";
import { DamageBoostAbAttr } from "./ab-attr/damage-boost-ab-attr";
import { AddSecondStrikeAbAttr } from "./ab-attr/add-second-strike-ab-attr";
import { MoveTypeChangeAbAttr } from "./ab-attr/move-type-change-ab-attr";
import { FieldMultiplyStatAbAttr } from "./ab-attr/field-multiply-stat-ab-attr";
import { FieldPreventExplosiveMovesAbAttr } from "./ab-attr/field-prevent-explosive-moves-ab-attr";
import { PostStatStageChangeStatStageChangeAbAttr } from "./ab-attr/post-stat-stage-change-stat-stage-change-ab-attr";
import { PostDefendWeatherChangeAbAttr } from "./ab-attr/post-defend-weather-change-ab-attr";
import { PostDefendCritStatStageChangeAbAttr } from "./ab-attr/post-defend-crit-stat-stage-change-ab-attr";
import { PostDefendContactApplyTagChanceAbAttr } from "./ab-attr/post-defend-contact-apply-tag-chance-ab-attr";
import { EffectSporeAbAttr } from "./ab-attr/effect-spore-ab-attr";
import { PostDefendContactApplyStatusEffectAbAttr } from "./ab-attr/post-defend-contact-apply-status-effect-ab-attr";
import { PostDefendTerrainChangeAbAttr } from "./ab-attr/post-defend-terrain-change-ab-attr";
import { PostDefendApplyArenaTrapTagAbAttr } from "./ab-attr/post-defend-apply-arena-trap-tag-ab-attr";
import { PostDefendHpGatedStatStageChangeAbAttr } from "./ab-attr/post-defend-hp-gated-stat-tage-change-ab-attr";
import { PostDefendStatStageChangeAbAttr } from "./ab-attr/post-defend-stat-stage-change-ab-attr";
...
import { IgnoreTypeStatusEffectImmunityAbAttr } from "./ab-attr/ignore-type-status-effect-immunity-ab-attr";
...
import { DoubleBattleChanceAbAttr } from "./ab-attr/double-battle-chance-ab-attr";
import { PostBattleInitFormChangeAbAttr } from "./ab-attr/post-battle-init-form-change-ab-attr";
import { PostBattleInitStatStageChangeAbAttr } from "./ab-attr/post-battle-init-stat-stage-change-ab-attr";
import { PreDefendFullHpEndureAbAttr } from "./ab-attr/pre-defend-full-hp-endure-ab-attr";
import { StabBoostAbAttr } from "./ab-attr/stab-boost-ab-attr";
import { ReceivedMoveDamageMultiplierAbAttr } from "./ab-attr/received-move-damage-multiplier-ab-attr";
import { AlliedFieldDamageReductionAbAttr } from "./ab-attr/allied-field-damage-reduction-ab-attr";
import { ReceivedTypeDamageMultiplierAbAttr } from "./ab-attr/received-type-damage-multiplier-ab-attr";
import { AttackTypeImmunityAbAttr } from "./ab-attr/attack-type-immunity-ab-attr";
import { TypeImmunityHealAbAttr } from "./ab-attr/type-immunity-heal-ab-attr";
import { TypeImmunityStatStageChangeAbAttr } from "./ab-attr/type-immunity-stat-stage-change-ab-attr";
import { TypeImmunityAddBattlerTagAbAttr } from "./ab-attr/type-immunity-add-battler-tag-ab-attr";
import type { AbAttrCondition } from "#app/@types/AbAttrCondition";
import { NonSuperEffectiveImmunityAbAttr } from "./ab-attr/non-super-effective-immunity-ab-attr";
import { FullHpResistTypeAbAttr } from "./ab-attr/full-hp-resist-type-ab-attr";
import { FieldPriorityMoveImmunityAbAttr } from "./ab-attr/field-priority-move-immunity-ab-attr";
import { MoveImmunityAbAttr } from "./ab-attr/move-immunity-ab-attr";
import { WonderSkinAbAttr } from "./ab-attr/wonder-skin-ab-attr";
import { MoveImmunityStatStageChangeAbAttr } from "./ab-attr/move-immunity-stat-stage-change-ab-attr";
...
import { PostDefendApplyBattlerTagAbAttr } from "./ab-attr/post-defend-apply-battler-tag-ab-attr";
import { PostDefendTypeChangeAbAttr } from "./ab-attr/post-defend-type-change-ab-attr";
import { PostDefendContactDamageAbAttr } from "./ab-attr/post-defend-contact-damage-ab-attr";
import { PostDefendPerishSongAbAttr } from "./ab-attr/post-defend-perish-song-ab-attr";
import { PostDefendAbilitySwapAbAttr } from "./ab-attr/post-defend-ability-swap-ab-attr";
import { PostDefendAbilityGiveAbAttr } from "./ab-attr/post-defend-ability-give-ab-attr";
import { PostDefendMoveDisableAbAttr } from "./ab-attr/post-defend-move-disable-ab-attr";
import { PokemonTypeChangeAbAttr } from "./ab-attr/pokemon-type-change-ab-attr";
import { FieldMoveTypePowerBoostAbAttr } from "./ab-attr/field-move-type-power-boost-ab-attr";
import { PostAttackStealHeldItemAbAttr } from "./ab-attr/post-attack-steal-held-item-ab-attr";
import { PostDefendStealHeldItemAbAttr } from "./ab-attr/post-defend-steal-held-item-ab-attr";
import { CopyFaintedAllyAbilityAbAttr } from "./ab-attr/copy-fainted-ally-ability-ab-attr";
import { IntimidateImmunityAbAttr } from "./ab-attr/intimidate-immunity-ab-attr";
import { PostSummonAllyHealAbAttr } from "./ab-attr/post-summon-ally-heal-ab-attr";
import { PostSummonClearAllyStatStagesAbAttr } from "./ab-attr/post-summon-clear-ally-stat-stages-ab-attr";
import { PostSummonCopyAbilityAbAttr } from "./ab-attr/post-summon-copy-ability-ab-attr";
import { PostSummonCopyAllyStatsAbAttr } from "./ab-attr/post-summon-copy-ally-stats-ab-attr";
import { PostSummonTransformAbAttr } from "./ab-attr/post-summon-transform-ab-attr";
import { PostSummonWeatherSuppressedFormChangeAbAttr } from "./ab-attr/post-summon-weather-suppressed-form-change-ab-attr";
import { ProtectStatAbAttr } from "./ab-attr/protect-stat-ab-attr";
import { ForewarnAbAttr } from "./ab-attr/forewarn-ab-attr";
import { FriskAbAttr } from "./ab-attr/frisk-ab-attr";
import { PostWeatherLapseHealAbAttr } from "./ab-attr/post-weather-lapse-heal-ab-attr";
import { PostWeatherLapseDamageAbAttr } from "./ab-attr/post-weather-lapse-damage-ab-attr";
import { PostTurnStatusHealAbAttr } from "./ab-attr/post-turn-status-heal-ab-attr";
import { PostTurnLootAbAttr } from "./ab-attr/post-turn-loot-ab-attr";
import { PostTurnHurtIfSleepingAbAttr } from "./ab-attr/post-turn-hurt-if-sleeping-ab-attr";
import { FetchBallAbAttr } from "./ab-attr/fetch-ball-ab-attr";
import { HealFromBerryUseAbAttr } from "./ab-attr/heal-from-berry-use-ab-attr";
import { ArenaTrapAbAttr } from "./ab-attr/arena-trap-ab-attr";
import { PostBattleLootAbAttr } from "./ab-attr/post-battle-loot-ab-attr";
import { PostFaintContactDamageAbAttr } from "./ab-attr/post-faint-contact-damage-ab-attr";
import { PostFaintHPDamageAbAttr } from "./ab-attr/post-faint-hp-damage-ab-attr";
import { BypassSpeedChanceAbAttr } from "./ab-attr/bypass-speed-chance-ab-attr";
import { TerrainEventTypeChangeAbAttr } from "./ab-attr/terrain-event-type-change-ab-attr";
