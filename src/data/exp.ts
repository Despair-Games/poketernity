 ...
 */
export function genFiveExpFormula(defeatedPokemon: EnemyPokemon, playerPokemon: PlayerPokemon): number {
  const baseExp = defeatedPokemon.getExpValue();
 ...
 * - O-Power bonus
 */
export function genSixExpFormula(defeatedPokemon: EnemyPokemon, playerPokemon: PlayerPokemon): number {
  const baseExp = defeatedPokemon.getExpValue();
  const enemyLevel = defeatedPokemon.level;
  // The Exp share multiplier is handled elsewhere (TODO: change that?)
  const expShareMultiplier = 1;
 ...
 * - Rotom Power bonus
 */
export function genSevenPlusExpFormula(defeatedPokemon: EnemyPokemon, playerPokemon: PlayerPokemon): number {
  const baseExp = defeatedPokemon.getExpValue();
  const enemyLevel = defeatedPokemon.level;
  const playerLevel = playerPokemon.level;
  // The Exp share multiplier is handled elsewhere (TODO: change that?)
