...
import { trainerConfigs } from "./balance/trainers/all-trainer-configs";
...
export const trainerTypeDialogue: TrainerTypeDialogue = {
  ...
  [TrainerType.ROOD]: [
    {
      encounter: ["dialogue:rood.encounter.1", "dialogue:rood.encounter.2", "dialogue:rood.encounter.3"],
      victory: ["dialogue:rood.victory.1", "dialogue:rood.victory.2", "dialogue:rood.victory.3"],
    },
  ],
