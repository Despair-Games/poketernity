...
export const LostAtSeaEncounter: MysteryEncounter = MysteryEncounterBuilder.withEncounterType(
  ...
  .withOnInit(() => {
    ...
    encounter.setDialogueToken("option1RequiredMove", new PokemonMove(null, OPTION_1_REQUIRED_MOVE).name);
    encounter.setDialogueToken("option2RequiredMove", new PokemonMove(null, OPTION_2_REQUIRED_MOVE).name);
