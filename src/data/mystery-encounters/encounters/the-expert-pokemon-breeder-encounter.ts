...
export const TheExpertPokemonBreederEncounter: MysteryEncounter = MysteryEncounterBuilder.withEncounterType(
  ...
  .withOnInit((scene: BattleScene) => {
    ...
    encounter.enemyPartyConfigs = [getPartyConfig(scene)];
    ...
    pokemonConfigs: [
      {
        ...
        modifierConfigs: [
          {
            modifier: generateModifierType(scene, modifierTypes.TERA_SHARD, [
              Type.STEEL,
...
function removePokemonFromPartyAndStoreHeldItems(
  scene: BattleScene,
