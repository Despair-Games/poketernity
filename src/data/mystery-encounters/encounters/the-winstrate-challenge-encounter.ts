  ...
  return {
    ...
    pokemonConfigs: [
      ...
      },
      {
        ...
        modifierConfigs: [
          {
            modifier: generateModifierType(scene, modifierTypes.ATTACK_TYPE_BOOSTER, [
              Type.PSYCHIC,
    ...
    pokemonConfigs: [
      {
        ...
        modifierConfigs: [
          ...
          {
            modifier: generateModifierType(scene, modifierTypes.BASE_STAT_BOOSTER, [
              Stat.HP,
            ]) as PokemonHeldItemModifierType,
            stackCount: 4,
            isTransferable: false,
  ...
  return {
    ...
    pokemonConfigs: [
      ...
      },
      {
        ...
        modifierConfigs: [
          {
            modifier: generateModifierType(scene, modifierTypes.BERRY, [
              BerryType.SITRUS,
            ]) as PokemonHeldItemModifierType,
            stackCount: 2,
          },
