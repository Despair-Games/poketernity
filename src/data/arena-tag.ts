...
class ReflectTag extends WeakenMoveScreenTag {
  ...
  override onAdd(_arena: Arena, quiet: boolean = false): void {
    if (!quiet) {
      globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:reflectOnAdd${this.i18nSideKey}`));
    }
  }
}
...
class LightScreenTag extends WeakenMoveScreenTag {
  ...
  override onAdd(_arena: Arena, quiet: boolean = false): void {
    if (!quiet) {
      globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:lightScreenOnAdd${this.i18nSideKey}`));
    }
  }
}
...
class AuroraVeilTag extends WeakenMoveScreenTag {
  ...
  override onAdd(_arena: Arena, quiet: boolean = false): void {
    if (!quiet) {
      globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:auroraVeilOnAdd${this.i18nSideKey}`));
    }
  }
}
...
class WishTag extends ArenaTag {
  ...
  override onRemove(_arena: Arena): void {
    ...
    if (target?.isActive(true)) {
      ...
      globalScene.phaseManager.queuePokemonHeal(true, target.getBattlerIndex(), this.healHp);
    }
  }
}
...
class TypeHazardTag extends EntryHazardTag {
  ...
  override onAdd(arena: Arena, quiet: boolean = false): void {
    ...
    const source = this.sourceId ? globalScene.getPokemonById(this.sourceId) : null;
    if (!quiet && source) {
      globalScene.phaseManager.queueMessage(i18next.t(this.onAddKey, { opponentDesc: source.getOpponentDescriptor() }));
    }
  }
...
class TailwindTag extends ArenaTag {
  ...
  override onAdd(_arena: Arena, quiet: boolean = false): void {
    if (!quiet) {
      globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:tailwindOnAdd${this.i18nSideKey}`));
    }
  ...
  override onRemove(_arena: Arena, quiet: boolean = false): void {
    if (!quiet) {
      globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:tailwindOnRemove${this.i18nSideKey}`));
    }
  }
}
...
class SafeguardTag extends ArenaTag {
  ...
  override onAdd(_arena: Arena): void {
    globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:safeguardOnAdd${this.i18nSideKey}`));
  }

  override onRemove(_arena: Arena): void {
    globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:safeguardOnRemove${this.i18nSideKey}`));
  }
}
...
class FireGrassPledgeTag extends ArenaTag {
  ...
  override onAdd(_arena: Arena): void {
    ...
    globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:fireGrassPledgeOnAdd${this.i18nSideKey}`));
  }
...
class WaterFirePledgeTag extends ArenaTag {
  ...
  override onAdd(_arena: Arena): void {
    ...
    globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:waterFirePledgeOnAdd${this.i18nSideKey}`));
  }
...
class GrassWaterPledgeTag extends ArenaTag {
  ...
  override onAdd(_arena: Arena): void {
    ...
    globalScene.phaseManager.queueMessage(i18next.t(`arenaTag:grassWaterPledgeOnAdd${this.i18nSideKey}`));
  }
}
