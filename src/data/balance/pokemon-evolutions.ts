...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [Species.CUBONE]: [
    new SpeciesEvolution(
      ...
      28,
      null,
      new SpeciesEvolutionCondition((_p) => globalScene.arena.isOfTimeOfDay([TimeOfDay.DUSK, TimeOfDay.NIGHT])),
    ),
    new SpeciesEvolution(
      Species.MAROWAK,
      28,
      null,
      new SpeciesEvolutionCondition((_p) => globalScene.arena.isOfTimeOfDay([TimeOfDay.DAWN, TimeOfDay.DAY])),
    ),
  ],
  [Species.TYROGUE]: [
    /**
  ...
  [Species.SLIGGOO]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition((_p) =>
        globalScene.arena.isOfWeather([WeatherType.RAIN, WeatherType.FOG, WeatherType.HEAVY_RAIN]),
      ),
  ...
  [Species.EEVEE]: [
    ...
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new SpeciesFriendshipEvolutionCondition(120, (_p) => globalScene.arena.isOfTimeOfDay(TimeOfDay.DAY)),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.ESPEON,
    ...
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new SpeciesFriendshipEvolutionCondition(120, (_p) => globalScene.arena.isOfTimeOfDay(TimeOfDay.NIGHT)),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.UMBREON,
  ...
  [Species.GLIGAR]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (_p) => globalScene.arena.isOfTimeOfDay([TimeOfDay.NIGHT, TimeOfDay.DUSK]) /* Razor fang at night*/,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.SNEASEL]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (_p) => globalScene.arena.isOfTimeOfDay([TimeOfDay.NIGHT, TimeOfDay.DUSK]) /* Razor claw at night*/,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
    ...
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          ...
          && globalScene.arena.isOfTimeOfDay([TimeOfDay.NIGHT, TimeOfDay.DUSK]),
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === MoveId.MIMIC).length > 0
          && globalScene.arena.isOfTimeOfDay([TimeOfDay.DAWN, TimeOfDay.DAY]),
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  ...
  [Species.ROCKRUFF]: [
    new SpeciesFormEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => globalScene.arena.isOfTimeOfDay([TimeOfDay.DAWN, TimeOfDay.DAY]) && p.formIndex === 0,
      ),
    ),
    new SpeciesFormEvolution(
      Species.LYCANROC,
    ...
    new SpeciesFormEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => globalScene.arena.isOfTimeOfDay([TimeOfDay.DUSK, TimeOfDay.NIGHT]) && p.formIndex === 0,
      ),
    ),
  ],
  [Species.STEENEE]: [
  ...
  [Species.MILCERY]: [
    new SpeciesFormEvolution(
      ...
      new SpeciesEvolutionCondition((_p) =>
        globalScene.arena.isOfBiome([Biome.TOWN, Biome.PLAINS, Biome.GRASS, Biome.TALL_GRASS, Biome.METROPOLIS]),
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      ...
      EvolutionItem.STRAWBERRY_SWEET,
      new SpeciesEvolutionCondition((_p) =>
        globalScene.arena.isOfBiome([Biome.BADLANDS, Biome.VOLCANO, Biome.GRAVEYARD, Biome.FACTORY, Biome.SLUM]),
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      ...
      EvolutionItem.STRAWBERRY_SWEET,
      new SpeciesEvolutionCondition((_p) =>
        globalScene.arena.isOfBiome([Biome.FOREST, Biome.SWAMP, Biome.MEADOW, Biome.JUNGLE]),
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      ...
      EvolutionItem.STRAWBERRY_SWEET,
      new SpeciesEvolutionCondition((_p) =>
        globalScene.arena.isOfBiome([Biome.MOUNTAIN, Biome.CAVE, Biome.ICE_CAVE, Biome.FAIRY_CAVE, Biome.SNOWY_FOREST]),
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
    ...
    new SpeciesFormEvolution(
      ...
      1,
      EvolutionItem.STRAWBERRY_SWEET,
      new SpeciesEvolutionCondition((_p) => globalScene.arena.isOfBiome([Biome.WASTELAND, Biome.LABORATORY])),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.ALCREMIE,
      ...
      1,
      EvolutionItem.STRAWBERRY_SWEET,
      new SpeciesEvolutionCondition((_p) => globalScene.arena.isOfBiome([Biome.TEMPLE, Biome.ISLAND])),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.ALCREMIE,
      ...
      1,
      EvolutionItem.STRAWBERRY_SWEET,
      new SpeciesEvolutionCondition((_p) => globalScene.arena.isOfBiome([Biome.SPACE, Biome.ABYSS, Biome.END])),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.DURALUDON]: [
  ...
  [Species.HISUI_SNEASEL]: [
    new SpeciesEvolution(
      ...
      EvolutionItem.RAZOR_CLAW,
      new SpeciesEvolutionCondition(
        (_p) => globalScene.arena.isOfTimeOfDay([TimeOfDay.DAWN, TimeOfDay.DAY]) /* Razor claw at day */,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  ...
  [Species.CHINGLING]: [
    new SpeciesEvolution(
      ...
      new SpeciesFriendshipEvolutionCondition(90, (_p) =>
        globalScene.arena.isOfTimeOfDay([TimeOfDay.DUSK, TimeOfDay.NIGHT]),
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
