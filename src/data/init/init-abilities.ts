...
import { PostTeraClearWeatherAndTerrainAbAttr } from "#app/data/abilities/ab-attrs/post-tera-clear-weather-and-terrain-ab-attr";
...
export function initAbilities() {
  allAbilities.push(
    ...
    new Ability(AbilityId.TERAFORM_ZERO, 9)
      .attr(UncopiableAbilityAbAttr)
      .attr(UnswappableAbilityAbAttr)
      .attr(PostTeraClearWeatherAndTerrainAbAttr),
