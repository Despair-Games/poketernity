...
export const signatureSpecies: SignatureSpecies = {
  ...
  MILO: [
    ...
    SpeciesId.APPLIN,
    [SpeciesId.CHERUBI, SpeciesId.BOUNSWEET],
    [SpeciesId.LOTAD, SpeciesId.SEEDOT],
  ],
  NESSA: [SpeciesId.CHEWTLE, SpeciesId.ARROKUDA, SpeciesId.WIMPOD, [SpeciesId.WOOPER, SpeciesId.MAREANIE]],
  KABU: [SpeciesId.SIZZLIPEDE, [SpeciesId.GROWLITHE, SpeciesId.VULPIX], SpeciesId.TORKOAL, SpeciesId.SALAZZLE],
  BEA: [SpeciesId.MACHOP, SpeciesId.GALAR_FARFETCHD, [SpeciesId.FALINKS, SpeciesId.CLOBBOPUS]],
  ALLISTER: [SpeciesId.GASTLY, SpeciesId.GALAR_YAMASK, SpeciesId.GALAR_CORSOLA],
  OPAL: [SpeciesId.MILCERY, SpeciesId.TOGEPI, SpeciesId.GALAR_WEEZING, SpeciesId.MAWILE],
  BEDE: [SpeciesId.HATENNA, SpeciesId.GALAR_PONYTA, SpeciesId.GARDEVOIR, SpeciesId.MAWILE],
  GORDIE: [SpeciesId.ROLYCOLY, SpeciesId.STONJOURNER, SpeciesId.BINACLE, [SpeciesId.SHUCKLE, SpeciesId.LARVITAR]],
  MELONY: [SpeciesId.LAPRAS, SpeciesId.SNOM, [SpeciesId.EISCUE, SpeciesId.GALAR_DARUMAKA], SpeciesId.GALAR_MR_MIME],
  PIERS: [SpeciesId.GALAR_ZIGZAGOON, [SpeciesId.SCRAGGY, SpeciesId.INKAY], [SpeciesId.STUNKY, SpeciesId.TOXEL]],
  MARNIE: [SpeciesId.IMPIDIMP, SpeciesId.MORPEKO, SpeciesId.PURRLOIN, [SpeciesId.CROAGUNK, SpeciesId.SCRAGGY]],
  RAIHAN: [SpeciesId.DURALUDON, SpeciesId.TRAPINCH, SpeciesId.GOOMY, [SpeciesId.ROGGENROLA, SpeciesId.SILICOBRA]],
