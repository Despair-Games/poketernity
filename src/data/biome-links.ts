...
export const biomeLinks: BiomeLinks = {
  ...
  [BiomeId.TALL_GRASS]: [BiomeId.FOREST, BiomeId.CAVE, BiomeId.CHARGESTONE_CAVE],
  ...
  [BiomeId.SEABED]: [BiomeId.CAVE, BiomeId.CHARGESTONE_CAVE, [BiomeId.VOLCANO, 3]],
  ...
  [BiomeId.ABYSS]: [BiomeId.CAVE, BiomeId.CHARGESTONE_CAVE, [BiomeId.SPACE, 2], [BiomeId.WASTELAND, 2]],
  ...
  [BiomeId.CHARGESTONE_CAVE]: [BiomeId.BADLANDS, BiomeId.LAKE, [BiomeId.LABORATORY, 2]],
