...
/**
 * When a Pokémon with this Ability is hit by a move that makes contact, \
 * there is a 9% chance of poison, 10% chance of paralysis, and 11% chance of sleep. \
 * The total sum of these chances is 30%.
 * @see {@link https://bulbapedia.bulbagarden.net/wiki/Effect_Spore_(Ability) | Effect Spore (Bulbapedia)}
 */
