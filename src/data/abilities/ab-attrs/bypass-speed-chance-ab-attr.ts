...
import type { MoveAbAttrParams } from "#types/ab-attr-param-types";
...
export class BypassSpeedChanceAbAttr extends AbAttr {
  ...
  public override apply({ pokemon, simulated }: MoveAbAttrParams): void {
    if (!simulated && pokemon.randSeedInt(100) < this.chance) {
      pokemon.addTag(BattlerTagType.BYPASS_SPEED);
    }
  }

  public override canApply({ move }: Parameters<this["apply"]>[0]): boolean {
