...
export default class PokemonSpecies extends PokemonSpeciesForm implements Localizable {
  public name: string;
  readonly category: SpeciesCategories;
...
export function initSpecies() {
  allSpecies.push(
    ...
    new PokemonSpecies(
      ...
      null,
      false,
      true, //Custom Catchrate, matching Baxcalibur
      new PokemonForm(
        "Normal",
        "",
        Type.STEEL,
    ...
    new PokemonSpecies(
      ...
      new PokemonForm(
        ...
        50,
        390,
      ), //Custom Ability, base form Hidden Ability
    ),
    new PokemonSpecies(
      Species.TIMBURR,
      5,
