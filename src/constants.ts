 ...
 */
export const MYSTERY_ENCOUNTER_BASE_SPAWN_WEIGHT = 3;
 ...
 */
export const MYSTERY_ENCOUNTER_WEIGHT_INCREMENT_ON_SPAWN_MISS = 3;
 ...
 */
export const MYSTERY_ENCOUNTER_AVERAGE_ENCOUNTERS_PER_RUN_TARGET = 12;
