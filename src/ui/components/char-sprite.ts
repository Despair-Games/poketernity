import { GAME_WIDTH, MISSING_TEXTURE_KEY } from "#app/constants/ui-constants";
...
export class CharSprite extends Phaser.GameObjects.Container {
  ...
  constructor() {
    super(globalScene, GAME_WIDTH + 32, -42);
  }
  ...
  showCharacter(key: string, variant: string): Promise<void> {
    return new Promise((resolve) => {
      ...
      this.setVisible(globalScene.textures.get(key).key !== MISSING_TEXTURE_KEY);
      this.shown = true;
