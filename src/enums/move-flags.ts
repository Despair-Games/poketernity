export enum MoveFlags {
   ...
   * - Pokemon affected by {@linkcode MoveIdTHROAT_CHOP Throat Chop} cannot use sound-based moves for two turns.
   ...
   * - All sound-based moves (except Howl) can hit Pokemon behind an active {@linkcode MoveIdSUBSTITUTE Substitute}.
   *
