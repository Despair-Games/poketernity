...
export enum TextColor {
  ...
  OFF_WHITE_GREY,
  SOFT_ORANGE_ORANGE,
  LIGHT_GREEN_SOFT_GREEN,
  LIGHT_BLUE,
  SOFT_PINK_DEEP_RED,
  GREY_LIGHT_GREY,
  LIGHT_GREY_GREY,
  MUTED_YELLOW_DARK_YELLOW,
  DARK_YELLOW_YELLOW,
  DEEP_RED_LIGHT_ORANGE,
  WARM_RED_DARK_BROWN,
  WARM_RED_LIGHT_RED,
  DEEP_ORANGE_LIGHT_BROWN,
  DEEP_YELLOW_OLIVE_BRONZE,
  DEEP_ORANGE_PEACH_SAND,
  CORAL_PINK_BRIGHT_RED,
}
